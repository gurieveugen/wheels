...
$NIMBUS_OPTIONS_ARR[] = array("name" => "Banner Options",
    ...
    "info" => "<p>You have the option of creating a variety of layouts for the banner area on your home page. Here's a breakdown of the options:</p>
                                    <ul>
                                        <li><strong>" . __('(1) Banner Content, Image with No Border:</strong> Banner content is located on the left. Static image is aligned top-right with no border. This is the setting we\'ve used for the Opulus Demo frontpage. You can use this no-border image to place a PNG (or JPG w/the same background color as the header) onto the frontpage.', 'nimbus_opulus_sombre') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_1.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example' /></li> 
                                        <li><strong>" . __('(2) Banner Content, Image with Border:</strong> Banner content is located on the left. Static image is aligned top-right with a border.', 'nimbus_opulus_sombre') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_2.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example'  /></li> 
                                        <li><strong>" . __('(3) Full Width Static Image With Border', 'nimbus_opulus_sombre') . "</strong><br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_3.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example' /></li> 
                                        ...
                                        <li><strong>" . __('(5) Full Width Slideshow:</strong> Full sized slideshow spans across the entire banner area.', 'nimbus_opulus_sombre') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_5.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example' /></li> 
                                        <li><strong>" . __('(6) Banner Content with Slideshow:</strong> Banner content is located on the left. Slideshow on the right side.', 'nimbus_opulus_sombre') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_6.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example'  /></li> 
                                        <li><strong>" . __('(7) Full Width Banner Content:</strong> Banner content spans full width.', 'nimbus_opulus_sombre') . "<br /><img src='" . get_template_directory_uri() . "/nimbus/images/banner_7.gif' style='margin:10px 0 10px 80px; border: 1px solid #B6B6B6;' alt='banner example' /></li> 
                                    </ul>",
...
$NIMBUS_OPTIONS_ARR[] = array("name" => __('Action Text', 'nimbus_opulus_sombre'),
    "desc" => __('This text wil be displayed in in the gradient box just below the header on the frontpage. Leave blank to remove row entirely.', 'nimbus_opulus_sombre'),
    "id" => "action_text",
    "tab" => "frontpage",
