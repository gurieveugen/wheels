...
function nimbus_options_scripts() {
    ...
    wp_register_script('jquery_cookie', get_template_directory_uri() . '/nimbus/js/jquery.cookie.js', array('jquery'), '1.0');
        ...
        <div id="options_wrapper">
            <div id="options_header">	
                <img id="panel_logo" src="<?php echo get_template_directory_uri(); ?>/nimbus/images/nimbus-panel.jpg" alt='Nimbus Panel'  />	
                   <a href="http://www.nimbusthemes.com/?utm_source=opulus_sombre&utm_medium=theme&utm_content=panel_banner&utm_campaign=opulus_sombre"><img id="panel_banner" src="<?php echo get_template_directory_uri(); ?>/nimbus/images/become-member.jpg" alt='Become a Member'  /></a>
            </div>
