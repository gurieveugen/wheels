/*
//////////////////////////////////////////////////////////////////////////////////
///////Copyright © 20014 Acutegroups Productions, http://www.acutegroups.org//////////
//////////////////////////////////////////////////////////////////////////////////
...
(function($) {
	...
	imagewidth: 50,
	imageheight: 50,
	center: '603 Washington Ave. Building 9C,South Amboy,NJ 08879',
	start: '#end',
        end: '#start',
    ...
    $.extend(GoogleMapObject.prototype, {
		...
		if (this.Settings.tooltip != 'false') {
		    var customtooltip = true;
			 var tooltipinfo ='603 Washington Ave. Building 9C,South Amboy,NJ 08879'.fontcolor('black');
